...
export class ProductsController {
  ...
  /////////////////// ⭐ AGREGADO CORRECTO
  @Get('creator/:email')
  async getProductsByCreator(@Param('email') email: string) {
    return await this.productsService.getProductsByCreatorEmail(email);
  }

  @Get('count/:email')
  async getProductCount(@Param('email') email: string) {
    const products = await this.productsService.getProductsByCreatorEmail(email);
...
//   }
//   ///////////////////prueba
//    // ⭐ AGREGADO: endpoint para traer productos por email
//    @Get('creator/:email')
//    async getProductsByCreator(@Param('email') email: string) {
//      return await this.productRepository.getProductsByCreatorEmail(email);
//    }
 
//    // ⭐ AGREGADO: endpoint para contar productos por email
//    @Get('count/:email')
//    async getProductCount(@Param('email') email: string) {
//      const products = await this.productRepository.getProductsByCreatorEmail(email);
//      return { count: products.length };
//    }
